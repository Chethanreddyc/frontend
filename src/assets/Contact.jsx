import {
  ...
  export default function contact() {
    return (
        <div className="fixed bottom-4 right-4 z-50"> {/* Positioning the badge */}
        <Popover placement="bottom-end">
          <PopoverHandler>
            <span className="inline-flex items-center justify-center w-10 h-10 bg-white text-white rounded-full cursor-pointer">
            <img 
          src={operator} // Replace with your image path
          alt="Badge Icon"
